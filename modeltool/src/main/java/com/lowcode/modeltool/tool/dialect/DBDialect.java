...
import com.lowcode.modeltool.tool.model.TableIndex;
import com.lowcode.modeltool.tool.model.TableIndexColumnField;
...
//            JdbcKit.close(pkStmt);
    ...
    protected boolean withoutLenDataType(int dataType) {
        int[] array = {Types.DATE, Types.TIMESTAMP, Types.TIME,
                ...
                Types.CLOB,Types.BLOB, Types.NCLOB,Types.INTEGER,
