...
import com.lowcode.modeltool.tool.fisok.raw.kit.DateKit;
...
public class Application {
    ...
    private static Map<String, Class<?>> commandRegister = new HashMap<String, Class<?>>() {{
        ...
        put("ParseExcelFileImpl", ParseExcelFileImpl.class);                    //解析Excel模板
        put("GenDocx", GenDocxImpl.class);                                      //生成WORD文档
        put("HttpParser", HttpParserImpl.class);                                      //生成WORD文档
    }};
