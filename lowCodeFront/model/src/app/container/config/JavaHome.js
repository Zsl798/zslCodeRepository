...
export default React.memo(({ prefix, dataSource, dataChange, config }) => {
  // const javaHome =
  //   config?.javaHome || dataSource?.profile?.javaHome || getJavaHome();
  ...
  //           id: 'config.JavaHomeConfigResult.error',
  //         }),
  ...
  //       Modal.success({
  //         title: FormatMessage.string({
  //           id: 'config.JavaHomeConfigResult.success',
  //         }),
  ...
  // return (
  //   <div className={`${currentPrefix}-setting-java-home`}>
  ...
  //             id: 'config.JavaHomeConfigResult.placeholder',
  //           })}
  //           onChange={onChange}
  //           value={value}
  //           suffix={
  //             <span className={`${currentPrefix}-setting-java-home-opt`}>
  //               <Icon
  //                 type="fa-ellipsis-h"
  //                 onClick={selectDir}
  //                 title={FormatMessage.string({ id: 'openDir' })}
  //               />
  //               <Button onClick={test}>
