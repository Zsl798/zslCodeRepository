...
import { reverseGetAllDBTablesList } from '../../../../api/project';
...
export default React.memo(forwardRef(({prefix, dataSource, getDbData, config,
  ...
  const parser = () => {
    ...
    reverseGetAllDBTablesList(properties).then((response) => {
        if (response.data.status === 'FAILED') {
          ...
          Modal.error({
            ...
            message: <div>
              <div style={{textAlign: 'center'}}><FormatMessage id='dbConnect.log'/>
