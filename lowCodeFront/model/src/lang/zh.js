export default {
  ...
  invalidProjectData:
    '无效的chnr文件，请先新建项目再执行导入操作！请勿直接修改项目后缀！',
  ...
  entityUniqueDefKeyError:
    '数据表或视图已经存在，请修改,重复数据表或视图有[{entities}]',
  entityHideInGraphSizeError:
    '关系图显示字段请选择能够代表本表业务含义的典型属性字段，限制为[{size}]个,超限数据表有[{entities}]，如需修改，请通过："设置->系统参数->关系图最大展示字段数"进行修改',
  ...
  hiddenGroup: '简单模式',
  hiddenGroupInfo: '可通过 设置/项目参数/模型默认显示模式 修改',
  moduleList: '数据模型',
  closeCurrent: '关闭当前',
  closeOthers: '关闭其他',
  closeAll: '关闭所有',
  noSelectedmTable: '未选择任何主表！请查询到数据模型终表与主表相匹配',
  noCanvasData: '当前关系图上未选择表',
  noMainTable: '没有主表',
  menus: {
    opt: {
      add: '新增',
  ...
  closeConfirm:
    '退出当前项目将会丢失所有未保存的数据，请确定已经执行保存操作！',
  ...
  deleteFromDiskConfirm: '您将会将此文件永久删除，请问你确认删除吗？',
  ...
  canvas: {
    ...
    node: {
      delete: '删除节点',
      entityHasOpen:
        '该数据表已被其他标签页占用!请关闭标签页或者把他拖到打开的数据表中!',
  ...
  dbConnect: {
    ...
    namePlaceholder: '连接名',
    customDriver: '自定义驱动',
    customDriverPlaceholder:
      '目前mysql,sqlserver,oracle,postgresql,db2,dm无需配置',
    driver: 'driver-class',
    url: 'url',
    username: 'username',
    password: 'password',
